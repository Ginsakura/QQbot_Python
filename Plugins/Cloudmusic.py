...
class Cloudmusic():
    ...
    def Main(self):
        ...
        if s1.group(2) == None:
            ...
            self.SearchID()
        return f'[CQ:music,type=163,id={self.songID}]'
        # return f"[CQ:record,file=http://music.163.com/song/media/outer/url?id={self.songID}.mp3]"
    ...
    def SearchText(self):
        param = {"hlpretag": "<span class=\"s-fc7\">", "hlposttag": "</span>", "s": f"\"{self.searchText}\"", "type": "1", "offset": "0",
